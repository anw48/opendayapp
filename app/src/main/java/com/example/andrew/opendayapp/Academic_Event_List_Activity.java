...
/**
 * This class is used to retrieve the list of events for an academic department based
...
public class Academic_Event_List_Activity extends ListActivity implements AdapterView.OnItemClickListener {
    ...
    /**
     * This class is used to retrieve the academic events
     ...
     */
    private class GetAcademicEvents extends AsyncTask<Void, Void, Void> {
     ...
     * @param json JSON string for web service
